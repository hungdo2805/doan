                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr align="center">
                                ...
                                <th>Tổng tiền</th>
                                <th>Ngày lập</th>
                                <th colspan="2" rowspan="">Tình trạng</th>
                                <th>CTHD</th>
                            </tr>
                        </thead>
                        <tbody>
                           @foreach($bill as $bill)
                            <tr class="odd gradeX" align="center">           
                               ...
                               <form action="{{url('admin/bill/xacnhan-vanchuyen/'.$bill->id)}}" method="get">
                                  <td style="width: 100px;"><button type="submit">Vận chuyển</button></td>
                               </form>
