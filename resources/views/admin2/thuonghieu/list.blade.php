                                           ...
                                           <form action="{{route('thuonghieu.store')}}" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required class="form-control" name="name" placeholder="Vui lòng nhập tên thương hiệu" />
                                                </div>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a type="button" class="btn btn-link btn-primary btn-lg"  data-toggle="modal" id="mediumButton" data-target="#mediumModal"
                                                        data-attr="{{ route('thuonghieu.edit',$th->id)  }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    <a  href="{{ route('thuonghieu.delete', $th->id) }}"  onclick="return confirm('Bạn có chắc chắn muốn xóa?')"  class="btn btn-link btn-danger  btn-lg" data-original-title="Remove">
